...
use App\Models\LearningPejabatSatuan;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\Validator;

class LearningPejabatSatuanController extends Controller
{
    public function index(Request $request)
    {
        try {
            $query = LearningPejabatSatuan::query()->with('satuan');
    ...
    public function store(Request $request)
    {
        try {
            ...
            $learning = new LearningPejabatSatuan();
    ...
    {
        try {
            $learning = LearningPejabatSatuan::find($id);
            if (!$learning) {
