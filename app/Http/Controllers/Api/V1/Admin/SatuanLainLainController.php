...
use App\Models\SatuanLainLain;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\Validator;

class SatuanLainLainController extends Controller
{
    public function index(Request $request)
    {
        try {
            $query = SatuanLainLain::query();
            ...
            return responseJson('All satuan lain lain', 200, 'Success', $data);
        } catch (\Throwable $th) {
    ...
    {
        try {
            $satuan = SatuanLainLain::where('id', $id)->first();
            if (!$satuan) {
            ...
            return responseJson('Show Satuan lain lain', 200, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return responseJson('Add satuan lain lain', 201, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return responseJson('Update satuan lain lain', 200, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            $satuan->delete();
            return responseJson('Delete satuan lain lain', 200, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
