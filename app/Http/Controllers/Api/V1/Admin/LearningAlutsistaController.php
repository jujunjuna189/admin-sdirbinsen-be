...
use App\Models\LearningAlutsista;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Storage;

class LearningAlutsistaController extends Controller
{
    public function index(Request $request)
    {
        try {
            $query = LearningAlutsista::query()->with('satuan');
    ...
    public function store(Request $request)
    {
        try {
            ...
            $learning = new LearningAlutsista();
    ...
    {
        try {
            $learning = LearningAlutsista::find($id);
            if (!$learning) {
