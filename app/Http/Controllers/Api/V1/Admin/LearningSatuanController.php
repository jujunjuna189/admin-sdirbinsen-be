...
use App\Models\LearningSatuan;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\Validator;

class LearningSatuanController extends Controller
{
    public function index(Request $request)
    {
        try {
            $query = LearningSatuan::query()->with('satuan');
    ...
    {
        try {
            $learning = LearningSatuan::find($id);
            if (!$learning) {
