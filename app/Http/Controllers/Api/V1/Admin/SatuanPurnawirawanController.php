...
use App\Models\SatuanPurnawirawan;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\Validator;

class SatuanPurnawirawanController extends Controller
{
    public function index(Request $request)
    {
        try {
            $query = SatuanPurnawirawan::query();
            ...
            return responseJson('All satuan Purnawirawan', 200, 'Success', $data);
        } catch (\Throwable $th) {
    ...
    {
        try {
            $satuan = SatuanPurnawirawan::where('id', $id)->first();
            if (!$satuan) {
            ...
            return responseJson('Show Satuan Purnawirawan', 200, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return responseJson('Add satuan Purnawirawan', 201, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
    ...
    {
        try {
            $satuan = SatuanPurnawirawan::find($id);
            if (!$satuan) {
                return responseJson('Data not found', 404, 'Error');
            }
            ...
            return responseJson('Update satuan Purnawirawan', 200, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
    ...
    public function destroy($id)
    {
        try {
            ...
            $satuan->delete();
            return responseJson('Delete satuan Purnawirawan', 200, 'Success', $data);
        } catch (\Throwable $th) {
            $errorMessage = $th->getMessage();
            return responseJson($errorMessage, 500, 'Error');
        }
